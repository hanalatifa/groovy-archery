...
<section class="py-20 sm:py-28 px-5 sm:px-6 bg-white dark:bg-slate-900 transition-colors duration-300">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-12 sm:mb-16">
            <p class="text-[10px] font-bold text-[#2b459a] dark:text-blue-400 uppercase tracking-[5px] mb-3">Program</p>
        ...
        <div class="overflow-hidden shadow-2xl rounded-2xl"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div class="lg:col-span-2 p-6 sm:p-8 md:p-10">
                    ...
                    <div class="inline-flex items-center px-5 py-2.5 mb-6 sm:mb-8 bg-white/95 dark:bg-slate-800/95">
                        <span class="text-gray-900 dark:text-slate-100 font-black text-sm">Pilih Program Sesuai Kebutuhanmu</span>
                    </div>
                    ...
                    style="background: rgba(61,45,181,0.1);">
                            ...
                            <p class="text-gray-500 text-sm mb-3 font-medium !text-gray-500">Regular (2× Seminggu)</p>
                            <p class="text-2xl font-black !text-[#1a1060]">Rp 300.000</p>
                            <p class="text-gray-400 text-xs mt-1.5 font-medium !text-gray-400">per bulan</p>
            ...
            <div class="program-card group p-5 sm:p-7 border-2 border-yellow-400
                ...
                <div class="absolute -top-3 left-4 bg-yellow-400 text-gray-900 text-[9px]
                    ...
                    <p class="text-gray-500 text-sm mb-3 font-medium !text-gray-500">Intensif (4× Seminggu)</p>
                ...
                <div class="flex flex-col items-center justify-center p-6 sm:p-8 text-center
                    ...
                    <div class="w-full max-w-xs px-6 py-5 bg-white/95 dark:bg-slate-800/90">
                        <p class="text-gray-500 dark:text-slate-400 text-sm font-medium mb-1">Hanya</p>
                        ...
                        <p class="text-gray-400 dark:text-slate-500 text-xs mt-2 font-medium">sekali bayar</p>
                    </div>
