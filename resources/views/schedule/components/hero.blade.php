    ...
    <div class="relative z-20 max-w-7xl mx-auto px-6 min-h-screen flex items-center">
        <div class="max-w-2xl py-32">
            ...
            <h1 class="hero-fade hero-delay-1 font-extrabold leading-[1.05] text-white mb-8"
                ...
                <span class="relative inline-block">
                    ...
                    <svg class="absolute -bottom-2 left-0 w-full" height="6" viewBox="0 0 200 6">
                        <line x1="0" y1="2" x2="400" y2="2" stroke="#DA4139" stroke-width="3" stroke-linecap="round"/>
                    </svg>
                </span><br>
                Prestasi.
            </h1>
            ...
            <p class="hero-fade hero-delay-2 text-gray-300 text-base md:text-lg leading-relaxed font-light max-w-xl mb-12">
                Jadwal latihan yang terstruktur dan konsisten adalah kunci utama dalam membentuk atlet yang tangguh dan berprestasi. <br>
                Dengan pendekatan yang disiplin, kami memastikan setiap atlet mendapatkan pelatihan yang optimal untuk mencapai potensi terbaik mereka.
            </p>
