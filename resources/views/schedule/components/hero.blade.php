...
<section class="relative min-h-screen overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <img src="{{ asset('assets/piala_walikota_jakut.jpg') }}" alt="Komunitas Pemanah"
        ...
        <div class="max-w-2xl py-32">
            ...
            <div class="hero-fade hero-delay-3 flex flex-wrap items-center gap-4">
                <button onclick="openDaftarModal()"
                    ...
                    <span class="relative z-10">{{ __('schedule.register_button') }}</span>
                ...
                <a href="#schedule"
                    ...
                    <span>{{ __('schedule.schedule_button') }}</span>
            ...
            <div class="hero-fade hero-delay-4 flex flex-wrap gap-10 mt-16 pt-10 border-t border-white/10">
                @foreach ([['3', __('schedule.training_locations')], ['9', __('schedule.years_established')], ['100+', __('schedule.active_athletes')]] as [$num, $label])
                    <div>
    ...
    <div
        ...
        <span class="text-[10px] text-gray-400 uppercase tracking-widest">{{ __('schedule.scroll') }}</span>
