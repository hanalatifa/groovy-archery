        {{-- Visi Misi Section --}}
        <section class="text-center pb-12 py-20">
            <p class="text-[10px] font-medium text-black uppercase mb-2">Visi Misi</p>
            <h2 class="text-3xl md:text-4xl font-semibold mb-4 text-gray-900">Mengapa Kami Ada?</h2>
