<section class="max-w-7xl mx-auto px-6 py-24 transition-colors duration-300" id="contact">
    ...
    <div class="mb-10">
        ...
        <p class="text-[10px] font-bold text-[#2b459a] dark:text-blue-400 uppercase tracking-[5px] mb-2">
            {{ __('landing.contact_label') }}
        </p>

        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3 transition-colors">
            {{ __('landing.contact_title') }}
        </h2>

        <p class="text-gray-400 dark:text-gray-500 text-sm max-w-md">
            {{ __('landing.contact_desc') }}
        </p>
    </div>
        ...
        <div class="space-y-8">
            ...
            <div class="flex items-start gap-4 group">
                ...
                <div class="w-10 h-10 rounded-sm bg-[#2b459a]/10 dark:bg-blue-900/20 border border-[#2b459a]/20 dark:border-blue-800/30 flex items-center justify-center flex-shrink-0 mt-0.5 transition-colors group-hover:bg-[#2b459a]/20">
                    ...
                    <svg class="w-4 h-4 text-[#2b459a] dark:text-blue-400"
                         fill="none"
                         stroke="currentColor"
                         viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <p class="font-bold text-sm text-gray-900 dark:text-gray-100 mb-1">
                        {{ __('landing.contact_email') }}
                    </p>

                    <p class="text-xs text-gray-400 dark:text-gray-500 mb-1">
                        {{ __('landing.contact_email_desc') }}
                    </p>

                    <a href="mailto:groovyarchery@gmail.com"
                       class="text-sm text-[#2b459a] dark:text-blue-400 hover:underline font-medium">
            ...
            <div class="flex items-start gap-4 group">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500 mb-1">
                        {{ __('landing.contact_whatsapp_desc') }}
                    </p>

                    <a href="https://wa.me/6281214711219"
                       class="text-sm text-gray-700 dark:text-gray-300 font-medium hover:text-[#2b459a] dark:hover:text-blue-400 transition-colors">
