        ...
        <section class="max-w-4xl mx-auto px-20 py-20 text-center">
            <p class="text-[10px] font-medium text-black uppercase mb-2">Tentang Kami</p>
            <h2 class="text-3xl md:text-4xl font-semibold mb-8 text-gray-900">Groovy Archery</h2>
