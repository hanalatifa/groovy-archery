...
<section class="py-24 px-6 bg-white dark:bg-slate-900 transition-colors duration-300" id="faq">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-10 md:mb-14">
            ...
            <p class="text-gray-400 dark:text-slate-500 text-sm">Temukan jawaban atas pertanyaan umum tentang program, jadwal, dan cara bergabung di Groovy Archery.</p>
        </div>
            ...
            <div class="faq-item border border-gray-100 dark:border-slate-700 rounded-2xl overflow-hidden
                ...
                <button class="faq-trigger w-full flex items-center justify-between gap-4
                    ...
                    <span class="flex items-center gap-4">
                        <span class="text-[10px] font-black text-[#2b459a] dark:text-blue-400 opacity-50 shrink-0 w-5">
                            {{ str_pad($i + 1, 2, '0', STR_PAD_LEFT) }}
                        </span>
                        <span class="text-sm md:text-base font-bold text-gray-800 dark:text-slate-100 
