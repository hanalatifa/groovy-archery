...
<section class="py-12 md:py-24 px-4 md:px-6 transition-colors duration-300 font-roboto" id="testimoni">
    ...
    <div class="text-center mb-10 md:mb-14">
        <p class="text-[10px] font-bold text-[#2b459a] dark:text-blue-400 uppercase tracking-[5px] mb-2">{{ __('landing.testimoni_label') }}</p>
        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-2">{{ __('landing.testimoni_title') }}</h2>
        <p class="text-gray-400 dark:text-gray-500 text-sm">{{ __('landing.testimoni_sub') }}</p>
    </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700
                        ...
                        <div class="flex items-center gap-3 mt-auto pt-5 border-t border-gray-50 dark:border-slate-700">
                            ...
                            <div>
                                ...
                                <p class="text-[10px] uppercase text-[#2b459a] dark:text-blue-400 font-semibold tracking-wider">{{ $testi->peran ?? __('landing.testimoni_verified') }}</p>
                            </div>
                        </div>
