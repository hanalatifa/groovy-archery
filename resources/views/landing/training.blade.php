    ...
    <div class="grid md:grid-cols-2 gap-16 items-center {{ $reverse ? 'md:[direction:rtl]' : '' }}">
        <div class="flex flex-col justify-center {{ $reverse ? '[direction:ltr]' : '' }}">
            <div class="flex items-center gap-3 mb-8">
                <span class="text-xs font-bold text-gray-300 dark:text-gray-600">{{ $num }}</span>
                <div class="w-5 h-px bg-gray-200 dark:bg-slate-700"></div>
                <span class="text-[10px] font-bold uppercase tracking-[3px] text-gray-400 dark:text-gray-500">{{ $type }}</span>
            </div>
            ...
            <div class="flex items-center gap-6">
                <div>
                    <p class="text-[10px] text-gray-400 dark:text-gray-500 mb-1.5 tracking-wide">Hubungi coach kami</p>
        ...
        <div class="img-frame {{ $reverse ? '[direction:ltr]' : '' }} group overflow-hidden rounded-sm">
