<x-layouts.admin-layout title="Edit Data Pertandingan">
    ...
    <div class="max-w-4xl mx-auto p-6">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-8">Edit Data Pertandingan</h1>
            ...
            <form action="{{ route('pertandingan.update', $pertandingan->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="col-span-1">
                        <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wider">Nama Pertandingan</label>
                    ...
                    <div class="col-span-1 md:col-span-2">
                        <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wider">Tanggal Pertandingan</label>
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-bold text-gray-700 mb-3 uppercase tracking-wider">Upload Dokumentasi Pertandingan (Klik untuk ganti)</label>
                        ...
                        <div class="photo-preview-container shadow-inner" id="photo-area">
                            ...
                            <div id="image-preview-wrapper" class="w-full h-full flex items-center justify-center p-4 gap-4 flex-wrap overflow-y-auto">
                                @if($pertandingan->dokumentasi && count($pertandingan->dokumentasi) > 0)
                                    @foreach($pertandingan->dokumentasi as $img)
                                        <img src="{{ asset('storage/' . $img) }}" class="h-full max-h-[280px] object-contain shadow-sm" alt="Dokumentasi">
                                    @endforeach
                                @else
                            ...
                            <div class="image-overlay">
                                <div class="text-center">
                                    ...
                                    <span class="text-white">Pilih Foto Baru (Bisa Banyak)</span>
                                </div>
                            </div>
                        </div>
                        <p class="text-xs text-gray-400 mt-2 italic">*Klik pada area di atas untuk memilih satu atau beberapa file baru dari perangkat anda (PNG, JPG, JPEG).</p>
                    </div>

                    <div class="md:col-span-2">
                        <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wider">Deskripsi Pertandingan</label>
    ...
    <script>
        ...
        fotoInput.addEventListener('change', function() {
            ...
            if (files && files.length > 0) {
                // Bersihkan isi preview lama ketika user memilih file baru
                previewWrapper.innerHTML = '';
                
                // Looping semua file yang dipilih dan render previewnya
