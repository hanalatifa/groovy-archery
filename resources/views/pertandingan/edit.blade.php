                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="photo-preview-container shadow-inner" id="photo-area">
                            <input type="file" name="dokumentasi" id="foto-input" accept="image/*" class="hidden">
                            ...
                            <div id="image-preview-wrapper" class="w-full h-full flex items-center justify-center p-4 gap-4 flex-wrap overflow-y-auto">
                                @if($pertandingan->dokumentasi)
                                    @if(is_array($pertandingan->dokumentasi))
                                        ...
                                        @endforeach
                                    @else
                                        <img src="{{ asset('storage/pertandingan/' . $pertandingan->dokumentasi) }}" class="h-full max-h-[280px] object-contain shadow-sm" alt="{{ __('dashboard.pertandingan_dokumentasi') }}">
                                    @endif
                                @else
