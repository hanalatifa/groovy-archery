...
<body class="antialiased bg-white dark:bg-slate-900 text-gray-900 dark:text-gray-100 transition-colors duration-300 overflow-x-hidden" style="font-family:'Montserrat',sans-serif;">
