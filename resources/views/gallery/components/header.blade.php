...
<section class="relative min-h-screen overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <img src="{{ asset('assets/sunnaharchery.jpeg') }}" alt="Komunitas Pemanah"
        ...
        <div class="max-w-2xl py-32">
            ...
            <div class="hero-fade hero-delay-3 flex flex-wrap items-center gap-4">
                <button onclick="openDaftarModal()"
                    ...
                    <span class="relative z-10">{{ __('gallery.hero_btn_daftar') }}</span>
                ...
                <a href="#athletes"
                    ...
                    <span>{{ __('gallery.hero_btn_lihat') }}</span>
            ...
            <div class="hero-fade hero-delay-4 flex flex-wrap gap-10 mt-16 pt-10 border-t border-white/10">
                {{-- Stats --}}
                @foreach ([['3', __('gallery.stat_lokasi')], ['9', __('gallery.stat_tahun')], ['100+', __('gallery.stat_atlet')]] as [$num, $label])
                    <div>
    ...
    <div
        ...
        <span class="text-[10px] text-gray-400 uppercase tracking-widest">{{ __('gallery.scroll') }}</span>
