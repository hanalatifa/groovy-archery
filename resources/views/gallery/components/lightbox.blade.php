<div id="glryLightbox"
    ...
    <button onclick="lbNav(-1)"
        ...
        <svg class="w-5 h-5 text-white transition-transform group-hover:-translate-x-0.5" fill="none"
    ...
    <div class="relative max-w-5xl w-full mx-4 md:mx-20 flex flex-col items-center">
        ...
        <div class="relative w-full overflow-hidden rounded-2xl">
            ...
            <div id="lbShimmer" class="absolute inset-0 bg-white/5 animate-pulse rounded-2xl"></div>
        </div>
        ...
        <div class="w-full mt-6 flex items-start justify-between gap-6">
            <div class="flex-1">
                ...
                <h2 id="lbJudul" class="text-white font-black text-xl md:text-2xl leading-tight mb-2"></h2>
                <p id="lbDesk" class="text-white/50 text-sm leading-relaxed max-w-xl font-light"></p>
            </div>

            <div class="hidden md:flex items-center gap-2 shrink-0 opacity-30">
                <kbd
                    class="bg-white/10 border border-white/15 rounded px-2 py-1 text-[10px] font-black text-white">←</kbd>
                <kbd
                    class="bg-white/10 border border-white/15 rounded px-2 py-1 text-[10px] font-black text-white">→</kbd>
                <span class="text-white/40 text-[10px] font-bold">{{ __('gallery.lightbox_nav') }}</span>
            </div>
        </div>
