...
<body class="bg-white antialiased text-gray-900">
    ...
    <nav class="flex items-center justify-between px-10 py-6 bg-white sticky top-0 z-50 shadow-sm">
        ...
        <div class="hidden md:flex items-center space-x-8">
            ...
            <a href="#" class="text-gray-700 font-medium hover:text-blue-600">Athletes</a>
            <a href="#" class="text-gray-700 font-medium hover:text-blue-600">Achievement</a>
            ...
            <a href="#" class="bg-[#2b459a] text-white px-6 py-2 rounded-md font-medium hover:bg-blue-800 transition">Login as Admin</a>
        </div>
    </nav>
    ...
    <section class="flex flex-col items-center justify-center py-20 px-6 text-center bg-gray-50">
        ...
        <p class="text-lg text-gray-600 max-w-2xl mb-10">
            Bergabunglah dengan komunitas pemanah yang berdedikasi. Berlatihlah bersama pelatih berpengalaman, berkompetisilah di tingkat tertinggi, dan raih tujuan Anda.
        </p>

        <div class="flex gap-4">
            <a href="#" class="bg-red-500 hover:bg-red-600 text-white px-8 py-3 rounded-md font-semibold transition duration-300">
                Daftar
            </a>
            <a href="#" class="border-2 border-gray-300 hover:border-gray-400 text-gray-700 px-8 py-3 rounded-md font-semibold transition duration-300">
                Lihat Atlet
            </a>
        </div>
    </section>
    ...
    <section class="w-full">
        <div class="overflow-hidden">
            <img src="{{ asset('assets/athletesimage.png') }}" alt="Komunitas Pemanah" class="w-full h-auto object-cover block">
        </div>
    </section>
    ...
    <div class="text-center mb-16">
        ...
        <p class="text-gray-600 mt-4">Setiap tembakan itu penting. Setiap momen itu berarti.</p>
    </div>

    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">

    @for ($i = 0; $i < 4; $i++)
    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition duration-300 flex flex-col">
        <img src="{{ asset('assets/atlet.jpg') }}" alt="Latihan" class="w-full h-60 object-cover block">

        <div class="p-5 flex flex-col flex-grow">
            <p class="text-blue-600 font-medium text-xs uppercase tracking-wider">Disiplin</p>
            <h3 class="text-lg font-bold text-gray-900 mt-2 mb-2 leading-tight">Latihan yang terarah</h3>
            <p class="text-gray-600 text-sm mb-4 leading-relaxed flex-grow">
                Discipline separates the serious from the casual. Our athletes train relentlessly...
            </p>
            <div class="mt-auto pt-2 border-t border-gray-100">
                <a href="#" class="text-blue-600 font-semibold flex items-center hover:underline text-sm">
                    Jelajah <span class="ml-2">→</span>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="text-center mt-12">
        <a href="#" class="bg-[#2b459a] text-white px-8 py-3 rounded-md font-medium hover:bg-blue-800 transition">Lihat Semua</a>
    </div>

    <div class="text-center mt-24 py-16 bg-gray-50 rounded-2xl mx-auto max-w-4xl px-8">
        <h2 class="text-3xl font-bold text-gray-900">Namamu belum tercantum?</h2>
        <p class="text-gray-600 mt-4 mb-8">Sudah bergabung dalam club tapi namamu belum tercantum? Request kepada admin untuk ditambahkan!</p>
        <a href="#" class="bg-[#2b459a] text-white px-8 py-3 rounded-md font-medium hover:bg-blue-800 transition">Tambahkan</a>
    </div>
</section>
