        ...
        <div class="max-w-2xl py-32">
            ...
            <div class="hero-fade flex items-center gap-3 mb-10">
                ...
                <span class="text-[10px] font-bold uppercase tracking-[5px] text-gray-300">
                    Club Persatuan Panahan Jakarta Utara
                </span>
            </div>
            ...
            <h1 class="hero-fade hero-delay-1 font-extrabold leading-[1.05] text-white mb-8"
                ...
                <span class="relative inline-block">
                    ...
                    <svg class="absolute -bottom-2 left-0 w-full" height="6" viewBox="0 0 200 6">
                        <line x1="0" y1="3" x2="200" y2="3" stroke="#DA4139" stroke-width="2.5" stroke-linecap="round"/>
                    </svg>
                </span><br>
                Keunggulan.
            </h1>
            ...
            <p class="hero-fade hero-delay-2 text-gray-300 text-base md:text-lg leading-relaxed font-light max-w-xl mb-12">
                Bergabunglah dengan komunitas pemanah yang berdedikasi. Berlatihlah bersama
                pelatih berpengalaman dan raih prestasi tertinggi.
            </p>
