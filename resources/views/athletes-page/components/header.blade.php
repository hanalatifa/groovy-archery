<section class="relative min-h-screen overflow-hidden bg-white">
    ...
    <div class="absolute inset-0 z-0">
        ...
        <img src="{{ asset('assets/gambar-2.png') }}" alt="Komunitas Pemanah"
    ...
    <div class="relative z-20 max-w-7xl mx-auto px-6 min-h-screen flex items-center">
        ...
        <div class="max-w-2xl py-32">
            ...
            <div class="hero-fade hero-delay-4 flex flex-wrap gap-10 mt-16 pt-10 border-t border-white/10">
                ...
                @foreach ([['3', __('athlets.stats_location')], ['9', __('athlets.stats_years')], ['100+', __('athlets.stats_active')]] as [$num, $label])
                    <div>
