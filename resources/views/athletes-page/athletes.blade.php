...
<body class="bg-white antialiased text-gray-900">
    ...
    <section class="flex flex-col items-center justify-center py-20 px-6 text-center bg-gray-50">
        ...
        <div class="flex gap-4">
            ...
            {{-- ✅ FIX ROUTE --}}
            <a href="{{ route('athletes') }}" class="border-2 border-gray-300 hover:border-gray-400 text-gray-700 px-8 py-3 rounded-md font-semibold transition duration-300">
                Lihat Atlet
            </a>
        </div>
    </section>
    ...
    <section class="py-20 px-6 bg-white">
        ...
        <div class="text-center mt-12">
            ...
            {{-- ✅ FIX ROUTE --}}
            <a href="{{ route('athletes') }}" class="bg-[#2b459a] text-white px-8 py-3 rounded-md font-medium hover:bg-blue-800 transition">
                Lihat Semua
            </a>
