                            ...
                            <td class="py-5 text-right">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <form action="{{ route('testi.reject', $t->id) }}" method="POST"
                                        onsubmit="return confirm('{{ __('dashboard.testimoni_reject_confirm') }}')">
                                        @csrf
                                        <button type="submit"
                                            class="px-5 py-2 border bg-red-200 text-red-500 rounded-none text-xs font-bold hover:bg-red-300 transition shadow-sm">
