<aside class="w-72 bg-white border-r border-gray-200 h-screen flex flex-col">
    ...
    <nav class="flex-1 px-3 py-6 overflow-y-auto">
        <ul class="space-y-1">
            <li>
                <a href="#" class="flex items-center gap-3 px-5 py-3.5 bg-purple-600 text-white rounded-2xl font-medium">
            ...
            <li>
                <a href="#" class="flex items-center gap-3 px-5 py-3.5 text-gray-700 hover:bg-gray-100 rounded-2xl font-medium transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li>
                <a href="#" class="flex items-center gap-3 px-5 py-3.5 text-gray-700 hover:bg-gray-100 rounded-2xl font-medium transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 19a2 2 0 01-2-2V7a2 2 0 012-2 2 2 0 01-2-2 2 2 0 012-2 2 2 0 01-2-2 2 2 0 012-2 2 2 0 01-2-2 2 2 0 012-2z" />
                    </svg>
