<aside class="w-72 bg-white border-r border-gray-200 h-screen flex flex-col">
    ...
    <div class="px-6 pt-8 pb-6 border-b border-gray-100">
        ...
        <p class="text-[10px] text-gray-400 mt-1 pl-1">{{ __('dashboard.sidebar_admin_panel') }}</p>
    </div>
        ...
        <ul class="space-y-1">
            ...
            <li>
                <a href="{{ route('atlet.index') }}"
                    class="flex items-center gap-3 px-5 py-3.5 {{ request()->routeIs('atlet.index') ? 'bg-purple-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} rounded-2xl font-medium transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-9 0H6m3-3v3m0 0v3m0-3H6" />
                    </svg>
            ...
            <li>
                <a href="{{ route('pertandingan.index') }}"
                    class="flex items-center gap-3 px-5 py-3.5 {{ request()->routeIs('pertandingan.*') ? 'bg-purple-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} rounded-2xl font-medium transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M5 19a2 2 0 01-2-2V7a2 2 0 012-2 2 2 0 01-2-2 2 2 0 012-2 2 2 0 01-2-2z" />
                    </svg>
            ...
            <a href="{{ route('atlet.kelola') }}"
                class="flex items-center gap-3 px-5 py-3.5 {{ request()->routeIs('atlet.kelola') ? 'bg-purple-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} rounded-2xl font-medium transition-colors">
            ...
            <li>
                <a href="{{ route('documentations.index') }}"
                    class="flex items-center gap-3 px-5 py-3.5 {{ request()->routeIs('documentations.*') ? 'bg-purple-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} rounded-2xl font-medium transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('testi.index') }}"
                    class="flex items-center gap-3 px-5 py-3.5 {{ request()->routeIs('testi.*') ? 'bg-purple-600 text-white' : 'text-gray-700 hover:bg-gray-100' }} rounded-2xl font-medium transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.975 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118L8.16 9.41c-.783-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                    </svg>
